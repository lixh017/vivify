...
**服饰** (round-robin 循环,同一集不重复): outfit_hufu_red (朱红汉服) / outfit_changshan_blue (宝蓝长衫) / outfit_workwear_orange (暖橙工装) / outfit_robe_green (翠绿僧袍) / outfit_jacket_redwhite (红白运动夹克)。
...
- 服饰必须从 5 套里选一件(朱红汉服 / 宝蓝长衫 / 暖橙工装 / 翠绿僧袍 / 红白运动夹克)
